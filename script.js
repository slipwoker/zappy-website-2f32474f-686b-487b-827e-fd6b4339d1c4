    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                const formAction = contactForm.getAttribute('action') || window.location.href;
                const formMethod = (contactForm.getAttribute('method') || 'POST').toUpperCase();
                ...
                fetch(formAction, fetchOptions)
                    ...
                    .then(function() {
                        ...
                        successMessage.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; background: #d4edda; border-radius: 4px;';
                    ...
                    .catch(function() {
                        ...
                        errorMessage.className = 'form-global-error';
                        errorMessage.style.cssText = 'color: #dc3545; padding: 1rem; margin-top: 1rem; background: #f8d7da; border-radius: 4px;';
        ...
        const animationObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    entry.target.classList.add('animated', 'fade-in-visible');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2f32474f-686b-487b-827e-fd6b4339d1c4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2f32474f-686b-487b-827e-fd6b4339d1c4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2f32474f-686b-487b-827e-fd6b4339d1c4';
